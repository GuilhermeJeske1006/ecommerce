...
{{--                            </p>--}}
                        <form>
                            <div class="p-t-15">
                                ...
                                <div class="bor8 bg0 m-b-12">
                                    <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Rua">
                                </div>
                                ...
                                <div class="bor8 bg0 m-b-22">
                                    <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Numero">
                                </div>
                    ...
                    <button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer js-show-modal2">
                        Ir para o pagamento
                    </button>
                </div>
            </div>
    ...
    @component('checkOut.payModal')@endcomponent
</form>
